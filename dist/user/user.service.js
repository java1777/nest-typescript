...
let UserService = class UserService {
    ...
    async create(createUserDto) {
        ...
        return (0, getSuccessResponse_1.getSuccessRes)(newUser, 201);
    }
    async findAll() {
        const users = await this.userModel.find().populate('posts');
        return (0, getSuccessResponse_1.getSuccessRes)(users);
    }
    async findOne(id) {
        ...
        return (0, getSuccessResponse_1.getSuccessRes)(user);
    }
