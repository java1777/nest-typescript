...
const users: User[] = [
    { id: 1, fullName: 'Javohir', isActive: true, role: 'admin' },
    { id: 2, fullName: 'Komol', isActive: true, role: 'admin' },
    { id: 3, fullName: 'Jamshid', isActive: false, role: 'guest' },
    { id: 4, fullName: 'Suxrob', isActive: false, role: 'guest' },
    { id: 5, fullName: 'Misha', isActive: false, role: 'guest' },
]
// console.log("Foydalanuvchilar ro'yxati:");
// users.forEach(user => {
    // console.log(`${user.id}. ${user.fullName} - ${user.role} (${user.isActive ? 'faol' : 'faolmas'})`);
// });
...
//     const discountInfo = product.discount !== null 
...
//     console.log(`${product.name} - ${product.price} so'm (${discountInfo}) -> ${Math.round(finalPrice)} so'm`);
// });
...
//     console.log(`Aholi soni: ${country.population.toLocaleString()} kishi`);
//     console.log(`Kenglik: ${country.location.latitude}`);
//     console.log(`Uzunlik: ${country.location.longitude}`);
// });
...
const dog = new Dogs("Simba", 2, "kuchuk")
...
const bank = new Bank(11112222, 100000000, 'Ipak Yoli Bank')
// console.log(bank.getInfo);
// bank.setBalance = 20000000
// bank.setBankName = 'Uzum Bank'
// console.log((bank.getInfo));
